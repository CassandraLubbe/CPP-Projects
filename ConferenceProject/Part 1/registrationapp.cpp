...
{
    // Take user input for the registration to be deleted
    ...
    // Takes user input for email to ensure correct registration is being deleted
    ...
    // initialize instance of registration list
    const QList<Registration*>& registrations = registrationList.getRegistrations();
    ...
    // set row numbers of items that were located in the table variables
    int row = item->row();
